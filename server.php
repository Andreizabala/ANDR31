...
if (isset($_POST['update'])) {
		...
		//we put strtoupper to convert string to uppercase
$no = strtoupper(test_input($_POST['no']));
$category = strtoupper(test_input($_POST['category']));
$title = strtoupper (test_input($_POST['title']));
$year = strtoupper (test_input($_POST['year']));
$author = strtoupper(test_input($_POST['author']));
